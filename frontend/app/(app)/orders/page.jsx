...
const orders = [
  {
    ...
    timeline: [
      ...
      { label: 'Shipped', date: 'Mar 27', done: true, active: true },
  ...
  },
  {
    ...
    timeline: [
      ...
      { label: 'Shipped', date: 'Mar 22', done: true, active: true },
                    ...
                    <div key={i} className="flex items-start flex-1">
                      <div className="flex flex-col items-center flex-1">
                        <div className="flex items-center w-full">
                          {i > 0 && <div className={`flex-1 h-0.5 -mr-1 ${selectedOrder.timeline[i - 1].done ? 'bg-green-400' : selectedOrder.timeline[i - 1].active ? 'progress-line-animated' : 'bg-gray-200 dark:bg-gray-600'}`} />}
