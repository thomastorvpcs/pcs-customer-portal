...
const stats = [
  ...
  { label: 'Outstanding Balance', value: '$47,230', sub: '$15,450 past due', subRed: true, link: 'View invoices', icon: DollarSign, iconColor: 'text-rose-500' },
...
const recentActivity = [
  ...
  { title: 'Invoice #INV-8834 generated', desc: '$24,750.00 · Due April 19, 2024', time: '4 hours ago', dot: 'bg-blue-500' },
  { title: 'Quote #QT-4421 awaiting approval', desc: '1,200 units Samsung Galaxy S23 · $106,000', time: 'Yesterday', dot: 'bg-yellow-500' },
    ...
    <div className="flex-1 p-8 bg-gray-50 overflow-auto">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg px-4 py-3 flex items-center justify-between mb-6">
        <div className="flex items-center gap-2 text-sm text-yellow-800">
          ...
          <span>
            You have 2 invoices past due totaling <strong>$2,450.00</strong>. Please review your outstanding balance to avoid service interruption.
          </span>
        </div>
