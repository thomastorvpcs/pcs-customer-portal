...
const accountSummary = [
  { label: 'Total Outstanding', value: '$247,850.00', sub: 'Across 12 invoices', subColor: 'text-gray-400', icon: FileText, iconColor: 'text-blue-500' },
  { label: 'Past Due', value: '$45,200.00', valueColor: 'text-red-500', sub: '3 invoices overdue', subColor: 'text-gray-400', icon: AlertTriangle, iconColor: 'text-red-400' },
  { label: 'Credit Limit', value: '$500,000', sub: '50% available', subColor: 'text-green-500', icon: CreditCard, iconColor: 'text-blue-500' },
  { label: 'Payment Terms', value: 'Net 30', sub: 'Standard terms', subColor: 'text-gray-400', icon: FileText, iconColor: 'text-blue-400' },
]
  ...
  return (
    <div className="flex-1 p-8">
      ...
      <section className="mb-6">
        <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Account Summary</h2>
      ...
      {/* Aging Summary */}
      <section className="mb-6">
        <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Aging Summary</h2>
        <div className="grid grid-cols-4 gap-4">
          ...
          <tbody className="divide-y divide-gray-50 dark:divide-gray-700">
            {invoices.map((inv) => (
              <tr key={inv.id} className="hover:bg-gray-50/50 dark:hover:bg-[#1a2540] transition-colors">
                ...
                <td className={`px-5 py-4 text-sm font-medium ${inv.balanceRed ? 'text-red-500' : inv.balanceGreen ? 'text-green-500' : 'text-gray-700 dark:text-gray-300'}`}>
                  {inv.balance}
                </td>
                <td className="px-5 py-4">
