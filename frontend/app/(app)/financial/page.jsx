      ...
      <div className="md:hidden min-h-screen bg-[#f1f5f9] dark:bg-[#0d1829] pb-4">
        ...
        {activeTab === 'Invoices' && (
          <div className="px-4 space-y-3">
            {invoices.map((inv) => (
              <div key={inv.id} className="bg-white dark:bg-[#152035] rounded-2xl p-4 border border-gray-100 dark:border-white/5">
                <div className="flex items-start justify-between mb-2">
                  <p className="text-sm font-bold text-gray-900 dark:text-white">{inv.id}</p>
                  <p className="text-sm font-bold text-green-500">{inv.amount}</p>
                </div>
        ...
        <div className="bg-white dark:bg-[#152035] rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
          ...
          {activeTab === 'Payments' && (
            <>
              ...
              <div className="flex items-center justify-between px-5 py-3 border-t border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                  Show <select className="border border-gray-200 dark:border-gray-600 rounded-md px-2 py-1 text-sm focus:outline-none bg-white dark:bg-[#1e2d45] text-gray-700 dark:text-gray-200"><option>10</option><option>25</option><option>50</option></select> per page
                </div>
